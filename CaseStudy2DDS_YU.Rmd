...
- Using alpha = 0.05, By doing a welch t-test, we failed to reject Null, which means 0 is plausible value between the two mean differences. It is telling us the difference of Monthly Income between gender is not significantly different from 0.
- Conclusion: The Female group actually has a higher mean of Monthly Income compared to Male 
...
- Conclusion: by using alpha = 0.05 level of significance, we discovered that there is no difference of percentage salary hike between Gender
- Scope: Not sure how these data is sampled, any inference to the population need to remain speculative
